            ...
            <div class="lg:col-span-2 bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl border border-gray-200 shadow-2xl hover:shadow-2xl transition-all duration-300">
                ...
                <form class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <textarea placeholder="Tulis pesan, kritik, atau saran Anda di sini..." rows="6"
                                class="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#389A92] focus:border-[#389A92] transition-all duration-300 group-hover:border-[#389A92]/50 bg-white shadow-sm resize-none"></textarea>
                    </div>
